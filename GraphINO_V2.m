    ...
    if isnan(PWM) || PWM <= 0;
        ...
        switch Nsens;
            case 1
                s(1) = a.analogRead(0);
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                plot(t,s(1),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(1))); ylabel('S - A0'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
            ...
            case 2
                ...
                plot(t,s(1),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(1))); ylabel('S - A0'); grid on; hold on;
                subplot(2,1,2);
                plot(t,s(2),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(2))); ylabel('S - A1'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
            ...
            case 3
                ...
                plot(t,s(2),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(2))); ylabel('S - A1'); grid on; hold on;
                subplot(3,1,3);
                plot(t,s(3),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(3))); ylabel('S - A2'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
            ...
            case 4
                ...
                plot(t,s(3),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(3))); ylabel('S - A2'); grid on; hold on;
                subplot(2,2,4);
                plot(t,s(4),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(4))); ylabel('S - A3'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
            ...
            case 5
                ...
                plot(t,s(4),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(4))); ylabel('S - A3'); grid on; hold on;
                subplot(2,3,5);
                plot(t,s(5),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(5))); ylabel('S - A4'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
            ...
            case 6
                ...
                plot(t,s(5),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(5))); ylabel('S - A4'); grid on; hold on;
                subplot(2,3,6);
                plot(t,s(6),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(6))); ylabel('S - A5'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 7
                ...
                plot(t,s(6),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(6))); ylabel('S - A5'); grid on; hold on;
                subplot(2,4,7);
                plot(t,s(7),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(7))); ylabel('S - A6'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 8
                ...
                plot(t,s(7),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(7))); ylabel('S - A6'); grid on; hold on; 
                subplot(2,4,8);
                plot(t,s(8),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(8))); ylabel('S - A7'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 9
                ...
                plot(t,s(8),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(8))); ylabel('S - A7'); grid on; hold on;   
                subplot(3,3,9);
                plot(t,s(9),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(9))); ylabel('S - A8'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 10
                ...
                plot(t,s(9),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(9))); ylabel('S - A8'); grid on; hold on; 
                subplot(2,5,10);
                plot(t,s(10),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(10))); ylabel('S - A9'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 11
                ...
                plot(t,s(10),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(10))); ylabel('S - A9'); grid on; hold on; 
                subplot(3,4,11);
                plot(t,s(11),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(11))); ylabel('S - A10'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 12
                ...
                plot(t,s(11),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(11))); ylabel('S - A10'); grid on; hold on;
                subplot(3,4,12);
                plot(t,s(12),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(12))); ylabel('S - A11'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 13
                ...
                plot(t,s(12),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(12))); ylabel('S - A11'); grid on; hold on;
                subplot(3,5,13);
                plot(t,s(13),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(13))); ylabel('S - A12'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
                fprintf(fid,'%15e %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d\n',...
        ...
        case 14
                ...
                plot(t,s(13),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(13))); ylabel('S - A12'); grid on; hold on;
                subplot(3,5,14);
                plot(t,s(14),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(14))); ylabel('S - A13'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 15
                ...
                plot(t,s(1),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(1))); ylabel('S - A0'); grid on; hold on;
                subplot(3,5,2);
                plot(t,s(2),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(12))); ylabel('S - A1'); grid on; hold on;
                subplot(3,5,3);
                plot(t,s(3),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(3))); ylabel('S - A2'); grid on; hold on;
                subplot(3,5,4);
                plot(t,s(4),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(4))); ylabel('S - A3'); grid on; hold on;
                ...
                plot(t,s(14),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(14))); ylabel('S - A13'); grid on; hold on;
                subplot(3,5,15);
                plot(t,s(15),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(15))); ylabel('S - A14'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
        ...
        case 16
                ...
                plot(t,s(15),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(15))); ylabel('S - A14'); grid on; hold on;
                subplot(4,4,16);
                plot(t,s(16),'.k','MarkerSize',MS); xlabel('t (s)'); title(sprintf('S = %d',s(16))); ylabel('S - A15'); grid on; hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fid = fopen(file,'a');
...
fclose('all');
delete(instrfind);
msgbox(sprintf('Data Stored at: %d',get(handles.file,'String')),'Ok!');
